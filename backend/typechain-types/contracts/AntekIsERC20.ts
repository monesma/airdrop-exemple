...
export interface AntekIsERC20Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface AntekIsERC20 extends BaseContract {
  connect(runner?: ContractRunner | null): AntekIsERC20;
  waitForDeployment(): Promise<this>;

  interface: AntekIsERC20Interface;
  ...
  mint: TypedContractMethod<
    [_to: AddressLike, _proof: BytesLike[]],
    [void],
    "nonpayable"
  >;
